...
/**
 * This class uses JDBC to perform CRUD operations on tables.
 * 
 * @author Cue
 *
 */
@SuppressWarnings("unused")
public class ProjectDoa extends DaoBase {
	...
	private List<Material> fetchMaterialsForProject(Connection conn, Integer projectId) 
		 ...
		 * @return the project with modified information
		 * @throws DbException Thrown if a SQLException is thrown by the driver.
		 */
	public boolean modifyProjectDetails(Project project) {
		...
		/**
		 	* This method used JDBC method calls to retrieve and delete a single project row, along with its associated
		 	* materials, steps, and categories.
		 	* 
